...
class CustomDataset(Dataset):
    def __init__(self, datapath, list_filename, training, img_suffix='left.tif'):
        self.datapath = datapath
        print(os.path.join(self.datapath, '*' + img_suffix))
        self.left_filenames = glob(os.path.join(self.datapath, '*' + img_suffix))
        self.right_filenames = [left.replace('left','right') for left in self.left_filenames]
        # self.left_filenames, self.right_filenames, self.disp_filenames = self.load_path(list_filename)
        self.left_filenames.sort()
        self.right_filenames.sort()
